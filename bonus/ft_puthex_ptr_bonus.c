...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ft_puthex_ptr_bonus.c                              :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: weiyang <marvin@42.fr>                     +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/06/15 14:38:25 by weiyang           #+#    #+#             */
/*   Updated: 2025/06/20 17:00:31 by weiyang          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_puthex_ptr_1_bonus(char *nbr, t_flags flags, int padding_zero
	, int padding_spaces)
{
	int	len;
...
int	ft_puthex_ptr_bonus(unsigned long n, t_flags flags)
{
	...
	len += ft_puthex_ptr_1_bonus(nbr, flags, padding_zero, padding_spaces);
	free (nbr);
	return (len);
}
